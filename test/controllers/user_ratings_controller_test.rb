...
class UserRatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_rating" do
    assert_difference('UserRating.count') do
      post user_ratings_url, params: { user_rating: { comment: @user_rating.comment, rating: @user_rating.rating, user_id: @user_rating.user_id } }
    end
  ...
  test "should update user_rating" do
    patch user_rating_url(@user_rating), params: { user_rating: { comment: @user_rating.comment, rating: @user_rating.rating, user_id: @user_rating.user_id } }
